...
data = dict(
    samples_per_gpu=1, # batch size =2 
    workers_per_gpu=4, 
    train=dict(
        type=dataset_type,
        data_root=data_root,
        palette=palette,
        classes=classes,
        img_dir=[data_root + "/images/training", data_root + "/images/validation"],
        ann_dir=[data_root + "/annotations/training", data_root + "/annotations/validation"],
