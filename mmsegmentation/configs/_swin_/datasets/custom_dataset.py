...
multi_scale = [(x, x) for x in range(256, 768+1, 128)]
test_multi_scale = [(512, 512), (768, 768), (1024, 1024)]
...
val_pipeline = [
    ...
    dict(
        ...
        img_scale=test_multi_scale,
        # img_ratios=[0.5, 0.75, 1.0, 1.25, 1.5, 1.75],
        flip=False,
        transforms=[
            dict(type='Resize', img_scale=test_multi_scale, multiscale_mode='value', keep_ratio=True),
